...
def upgrade() -> None:
    # Create enums
    tipo_comprobante_enum = postgresql.ENUM(
        'factura', 'recibo', 'nota_credito', 'nota_debito', 'presupuesto',
        name='tipocomprobanteenum'
    )
    tipo_comprobante_enum.create(op.get_bind(), checkfirst=True)

    estado_comprobante_enum = postgresql.ENUM(
        'borrador', 'emitido', 'pagado_parcial', 'pagado_total', 'anulado', 'vencido',
        name='estadocomprobanteenum'
    )
    estado_comprobante_enum.create(op.get_bind(), checkfirst=True)
    ...
    op.create_table('comprobantes',
        ...
        sa.Column('tipo', sa.Enum('factura', 'recibo', 'nota_credito', 'nota_debito', 'presupuesto', name='tipocomprobanteenum'), nullable=False),
        ...
        sa.Column('estado', sa.Enum('borrador', 'emitido', 'pagado_parcial', 'pagado_total', 'anulado', 'vencido', name='estadocomprobanteenum'), nullable=False, server_default='borrador'),
