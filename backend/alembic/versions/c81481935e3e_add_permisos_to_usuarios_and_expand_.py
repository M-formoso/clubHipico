...
def upgrade() -> None:
    ...
    # Use existing enum types (all should already exist)
    tipoalertaenum = postgresql.ENUM('VACUNA', 'HERRAJE', 'PAGO', 'EVENTO', 'CUMPLEAÑOS', 'CONTRATO', 'STOCK', 'TAREA', 'MANTENIMIENTO', 'VETERINARIA', 'OTRO', name='tipoalertaenum', create_type=False)
