...
export function EmpleadoCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (data: any) => empleadoService.create(data),
    onSuccess: (data) => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Registra un nuevo empleado en el sistema</p>
        </div>
      </div>
